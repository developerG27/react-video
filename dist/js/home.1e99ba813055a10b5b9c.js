...
/******/ 	__webpack_require__.p = "C:\\Users\\developerG27\\Desktop\\react-video\\dist/";
/******/
...
//importo i css di Video Player che si trovano nella stessa cartella

var VideoPlayerLayout = function VideoPlayerLayout(props) {
  return (//arrow function che riceve come parametro le proprietà
...
var _related = __webpack_require__(46);
...
function Playlist(props) {
  ...
  return _react2.default.createElement(
    ...
    props.playlist.map(function (item) {
      // spread operator
      return _react2.default.createElement(_media2.default, _extends({ openModal: props.handleOpenModal }, item, {
        key: item.id }));
    })
  );
}
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //Importo il validatore delle proprietà
...
var Media = function (_PureComponent) {
  ...
  function Media() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Media.__proto__ || Object.getPrototypeOf(Media)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.props.openModal(_this.props); //apre il modale
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Media, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'Media', onClick: this.handleClick /*al click fai partire la funzione handleClick*/ },
        _react2.default.createElement(
          'div',
...
Media.propTypes = {
  cover: _propTypes2.default.string, //stringa
  title: _propTypes2.default.string.isRequired, //stringa.obbigatoria
  author: _propTypes2.default.string, //stringa
  type: _propTypes2.default.oneOf(['video', 'audio']) //una dei due: video o audio
};

exports.default = Media; //esporto componente Media
...
module.exports = __webpack_require__.p + "images/logo.e87f7764e954efcc932c87185735d88a.png";
...
var _videoPlayerLayout = __webpack_require__(17);
...
function Modal(props) {
  return _react2.default.createElement(
    ...
    { className: 'Modal' },
    props.children,
    _react2.default.createElement('button', { className: 'Modal-close', onClick: props.handleClick })
  );
}
...
var _regularError = __webpack_require__(54);
...
var HandleError = function (_Component) {
  ...
  _createClass(HandleError, [{
    ...
    value: function componentDidCatch(error, info) {
      //invia questo errore ad un servizio como Sentry
      this.setState({
        handleError: true
      });
    }
...
var VideoPlayer = function (_Component) {
  ...
  function VideoPlayer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = VideoPlayer.__proto__ || Object.getPrototypeOf(VideoPlayer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState({ //cambia lo stato
      ...
      if (!document.webkitIsFullScreen) {
        //Se è diverso da FullScreen
        _this.player.webkitRequestFullScreen(); //entra in FullScreen
      } else {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        _videoPlayerLayout2.default //componente che racchiude tutto
        ,
        { setRef: this.setRef
        },
        _react2.default.createElement(_title2.default //componente del titolo del video
        , { title: this.props.title
        }),
        _react2.default.createElement(
          _videoPlayerControls2.default /*Componente che racchiude i controlli */,
          null,
          _react2.default.createElement(_playPause2.default //Componente che si intercambia tra il Play e pause
          , { pause: this.state.pause,
            handleClick: this.togglePlay
          }),
          _react2.default.createElement(_timer2.default //Componente della durata del video
          , { duration: this.state.duration,
            currentTime: this.state.currentTime
          }),
          _react2.default.createElement(_progressBar2.default //Componente della barra di progresso
          , { duration: this.state.duration,
            value: this.state.currentTime,
            handleProgressChange: this.handleProgressChange
          }),
          _react2.default.createElement(_volume2.default //Componente per gestire il volume
          , { handleVolumeChange: this.handleVolumeChange
          }),
          _react2.default.createElement(_fullScreen2.default //Componente che fa diventare a schermo intero
          , { handleFullScreenClick: this.handleFullScreenClick
          })
        ),
        ' ',
        _react2.default.createElement(_spinner2.default //Componente che si presenta quando c'è il caricamento in corso, per 'risolvere' il delay del video
        , { active: this.state.loading
        }),
        _react2.default.createElement(_video2.default //Componente del vide
...
var Video = function (_Component) {
  ...
  function Video() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Video.__proto__ || Object.getPrototypeOf(Video)).call.apply(_ref, [this].concat(args))), _this), _this.setRef = function (element) {
      //arrow function
      _this.video = element; //video ha il valore di elemento
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Video, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      //funzione che si usa quando il componente riceve nuove proprietà
      if (nextProps.pause !== this.props.pause) {
        //se la nuova proprietà pausa è diversa dalla proprietà pausa
    ...
    value: function render() {
      var _props = this.props,
          ...
          handleSeeked = _props.handleSeeked; //le aggiunge alle proprietà
...
function leftPad(number) {
  //Mi sono ispirato ad una funzione trovata online
  var pad = '00'; //dichiaro una costante con un valore string di 00 che sarà il suo valore di default
  return pad.substring(0, pad.length - number.length) + number; //la funzione substring mi permette sostituire il valore  
}

function formattedTime(secs) {
  var minutes = parseInt(secs / 60, 10); //trasforma i secondi in minuti e lo trasforma in numero intero
  var seconds = parseInt(secs % 60, 10); //riporta quello che rimane dopo 60 secondi (5 % 2 = 1), lo trasforma in numero intero
...
function ProgressBar(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('input', { //un input di tipo range con un valore massimo in base al video caricato 
      type: 'range',
      min: 0,
      max: props.duration,
      value: props.value,
...
function FullScreen(props) {
  return _react2.default.createElement(
    'div',
    { className: 'FullScreen', onClick: props.handleFullScreenClick /*Dopo il click fai partire la funzione*/ },
    _react2.default.createElement(_fullScreen2.default //Componente full screen con le proprietà
    , { size: 25,
      color: 'white'
    })
  );
...
module.exports = {"categories":[{"id":1,"description":"Il meglio della settimana","title":"In primo piano","playlist":[{"title":"Cos'è Responsive Design","author":"Author","type":"video","cover":"./images/covers/responsive.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":1},{"title":"Come ottimizzare il caricamento di un sito web","author":"Author","type":"video","cover":"./images/covers/optimizar.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":2},{"title":"Cos'è Bitcoin","author":"Author","type":"video","cover":"./images/covers/bitcoin.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":3},{"title":"Cosa cambia con HTML 5fdsfsd.1","author":"Author","type":"video","cover":"./images/covers/html5.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":4},{"title":"Presentati i nuovi iPhone","author":"Author","type":"video","cover":"./images/covers/iphone.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":5}]},{"id":2,"description":"Il meglio","title":"Per programmatori","playlist":[{"title":"Mr.Robot","author":"Author","type":"video","cover":"./images/covers/mr-robot.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":1},{"title":"Microsoft compra Github","author":"Author","type":"video","cover":"./images/covers/microsoft-github.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":5},{"title":"Guida a React Native","author":"Author","type":"video","cover":"./images/covers/react-native.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":2},{"title":"The social network","author":"Author","type":"video","cover":"./images/covers/social.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":4},{"title":"Il progetto SpaceX","author":"Author","type":"video","cover":"./images/covers/spacex.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":3}]},{"id":3,"description":"Il meglio per rilassarti","title":"Musica","playlist":[{"title":"Despacito","author":"Luis Fonsi","type":"video","cover":"./images/covers/despacito.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":1},{"title":"In my Feelings","author":"Drake","type":"video","cover":"./images/covers/kiki.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":3},{"title":"Mi Gente","author":"J Bavil","type":"video","cover":"./images/covers/mi-gente.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":2},{"title":"Felices los 4","author":"Maluma","type":"video","cover":"./images/covers/felices.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":4},{"title":"Me Rehúso","author":"Danny Ocean","type":"video","cover":"./images/covers/rehuso.jpg","src":"http://peach.themazzone.com/durian/movies/sintel-1024-surround.mp4","id":5}]}]}
